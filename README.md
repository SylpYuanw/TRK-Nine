...
- `鼠鼠收尾人们目前已到245679协会/`：MOD 本体，可直接放入 RimWorld 的 `Mods` 目录（About / Assemblies / Defs / Languages / Patches / Sounds / Textures）。
- `Source/`：C# 源码工程与设计文档。
...
关联文件：`鼠鼠收尾人们目前已到245679协会/AssetBundles/trk_bowofdeath_win`、`鼠鼠收尾人们目前已到245679协会/Defs/ShaderTypeDefs/BowOfDeath_Shaders.xml`、`鼠鼠收尾人们目前已到245679协会/Defs/Misc/Mote_BowOfDeath.xml`、`鼠鼠收尾人们目前已到245679协会/Defs/ThingDefs_Items/Weapon_BowOfDeath.xml`、`鼠鼠收尾人们目前已到245679协会/Assemblies/ClassLibrary1.dll`、`Source/ClassLibrary1/Weapon/BowOfDeath/Mote_DeathBowAimVfx.cs`、`Source/死之弓_实现与依据.md`
...
Related files: `鼠鼠收尾人们目前已到245679协会/AssetBundles/trk_bowofdeath_win`, `鼠鼠收尾人们目前已到245679协会/Defs/ShaderTypeDefs/BowOfDeath_Shaders.xml`, `鼠鼠收尾人们目前已到245679协会/Defs/Misc/Mote_BowOfDeath.xml`, `鼠鼠收尾人们目前已到245679协会/Defs/ThingDefs_Items/Weapon_BowOfDeath.xml`, `鼠鼠收尾人们目前已到245679协会/Assemblies/ClassLibrary1.dll`, `Source/ClassLibrary1/Weapon/BowOfDeath/Mote_DeathBowAimVfx.cs`, `Source/死之弓_实现与依据.md`
...
关联文件：`Source/ClassLibrary1/Weapon/BowOfDeath/CompEquippable_DeathBow.cs`、`Source/ClassLibrary1/Weapon/BowOfDeath/Properties_DeathBow.cs`、`Source/ClassLibrary1/Weapon/BowOfDeath/DeathBowDefOf.cs`、`Source/死之弓_实现与依据.md`、`鼠鼠收尾人们目前已到245679协会/Defs/SoundDefs/Sounds_BowOfDeath.xml`、`鼠鼠收尾人们目前已到245679协会/Defs/Misc/Mote_BowOfDeath.xml`、`鼠鼠收尾人们目前已到245679协会/Defs/ThingDefs_Items/Weapon_BowOfDeath.xml`、`鼠鼠收尾人们目前已到245679协会/Sounds/`、`鼠鼠收尾人们目前已到245679协会/Textures/VFX/Bow_of_Death_Stage_Vfx.png`、`鼠鼠收尾人们目前已到245679协会/Assemblies/ClassLibrary1.dll`
